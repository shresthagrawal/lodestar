...
import { isBetterUpdate } from "./utils/update.js";
...
export class Lightclient {
    ...
    static async initializeFromCheckpointRoot({ config, logger, beaconApiUrl, genesisData, checkpointRoot, }) {
        ...
        if (!isValidMerkleBranch(ssz.altair.SyncCommittee.hashTreeRoot(currentSyncCommittee), currentSyncCommitteeBranch, CURRENT_SYNC_COMMITTEE_DEPTH, CURRENT_SYNC_COMMITTEE_INDEX, header.stateRoot)) {
